%%%% This is the script that has the correct parameters for rec_1
...
I = read_rec('needle_rec_1.rec');

%% threshold image

thr         = 0.29;         % threshold value
...
%% generate bi-Cone
height = 0.25;                   % height
mid_rad= 0.07;                   % radius of the middle circle
...
xlswrite('Scenter_rec_1.xlsx',Scenter)
xlswrite('thetai_rec_1.xlsx',thetai)
xlswrite('phii_rec_1.xlsx',phii)